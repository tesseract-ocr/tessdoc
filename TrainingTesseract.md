...
Recommended editors that supports UTF-8: Notepad++, gedit, KWrite, Geany, Vim, Emacs, Atom.io, TextMate,  Sublime Text. Choose one! Linux and Windows both have a character map that can be used for copying characters that cannot be typed.
