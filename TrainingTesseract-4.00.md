...
*   [Tutorial Guide to lstmtraining](#tutorial-guide-to-lstmtraining)
    *   [LSTMTraining Command Line](#lstmtraining-command-line)
        *   [Unicharset Compression](#unicharset-compression-and-train-mode)
        *   [Randomized Training Data](#randomized-training-data-and-train-mode)
...
:                        :          :             : initialize         :
:                        :          :             : weights.           :
| `momentum`             | `double` | `0.9`       | Momentum for alpha |
:                        :          :             : smoothing          :
:                        :          :             : gradients.         :
